...
//		this.block[aPoint.x][aPoint.y].getPanelBlock().add(label);
	...
	public void setObstacleOfBoard(Point aPoint) {
		this.block[aPoint.x][aPoint.y].isObstacle = true;
		this.block[aPoint.x][aPoint.y]._btnBlock.setBackground(Color.black);
	}
}
